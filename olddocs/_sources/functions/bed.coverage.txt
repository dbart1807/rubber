...
``bed.coverage`` counts the number genomic intervals in one bed file that overlap at each genomic interval in another bed file.
...
::
  ...
  bed.coverage ( bedfile , windowbed , windowsize=25 , stepsize=windowsize , scalar="rpm" )
...
output
**************************************************************************
``bed.coverage`` generates a bedGraph file counting the number of intervals in 'bedfile' that overlap with the intervals in 'windowbed'.
...
If the intervals in 'windowbed' overlap, ``bed.coverage`` can reduce the size of these intervals if 'windowsize' and 'stepsize' are defined.
...
::
 ...
 > bed.coverage ( "MNaseSeqFragments" , windows )
...
::
 ...
 > bed.coverage ( "MNaseSeqCenters.bed" , seqcapwindows , windowsize=100 , stepsize = 10)
