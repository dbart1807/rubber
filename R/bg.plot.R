bg.plot <- function( bgFiles , regions , plotcolors=rainbow(length(bgFiles)), legendnames=basename(removeext(bgFiles)) ,  threads=getOption("threads",1L) , linetypes=1, linewidths=3, lspan=0 ) {
